...
class ProductTestCase(TestCase):
    ...
    def setUp(self):
        ...
        # Create a staff user
        test_user1 = User.objects.create_user(email='testuser1@gmail.com', password='1X<ISRUkw+tuK', is_staff=True)  # noqa: E501
        test_user1.save()
        self.client.login(username='testuser1@gmail.com', password='1X<ISRUkw+tuK')  # noqa: E501
    ...
    def test_product_add_n_times_with_n_sizes(self):
        ...
        response = self.client.post(reverse('add_product'), data={'name': 'test_name',  # noqa: E501
                                                                  'description': 'test_description',  # noqa: E501
                                                                  'price': 24.5,  # noqa: E501
                                                                  'quantity': 3,  # noqa: E501
                                                                  'sizes': (5, 6),  # noqa: E501
                                                                  'genders': ('MEN', 'WOMEN')})  # noqa: E501
